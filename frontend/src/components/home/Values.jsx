...
import image from '../../assets/congo/aid.png'
    ...
    <div className="w-full  bg-white">
      ...
      <div className="relative overflow-hidden py-5 md:py-10 px-4 md:px-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-20 left-10 w-64 h-64 bg-secondary-500 rounded-full blur-3xl"></div>
        ...
        <div className="relative mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-secondary-500/10 backdrop-blur-sm px-6 py-3 rounded-full border border-secondary-400/30 shadow-lg shadow-secondary-500/20">
                <div className="w-2 h-2 bg-secondary-400 rounded-full animate-pulse"></div>
                <span className="text-secondary-300 font-semibold text-sm tracking-wider uppercase">
              ...
              <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight">
                ...
                <span className="relative inline-block">
                  ...
                  <span className="absolute inset-x-0 bottom-2 h-3 bg-secondary-500 -z-0"></span>
                </span>
              </h2>
